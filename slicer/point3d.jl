...
# Define isless and > so that we can do lexical comparisons of Point3D.
function Base.isless(a::Point3D, b::Point3D)
    return (a[1] < b[1]) || 
           (a[1] == b[1] && a[2] < b[2]) ||
...
function Point3DCache()
    return Point3DCache(Dict{NTuple{3, Float64}, Point3D}(),
                        9e99, 9e99, 9e99,
                        -9e99, -9e99, -9e99)
end
